...
**** 语法
 ...
 3. 变量
    ...
    4. 变量名允许包含字母、数字、美元符号和下划线（第一个字符不允许是字母）
...
*** TODO 复习总结前五章
    DEADLINE: <2016-07-31 日>
*** TODO 第六章 案例研究：图片库改进
    DEADLINE: <2016-07-30 六> SCHEDULED: <2016-07-28 四>
*** TODO 第七章 动态创建标记
    DEADLINE: <2016-07-30 六> SCHEDULED: <2016-07-29 五>
*** TODO 第八章 充实文档的内容
    DEADLINE: <2016-07-30 六> SCHEDULED: <2016-07-30 六>
** 慕课网
** 相关网站
