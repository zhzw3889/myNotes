...
* Git/Github
** TODO 《GitHub入门与实践》
   DEADLINE: <2016-08-17 三> SCHEDULED: <2016-08-04 四>
   :PROPERTIES:
   :Effort:   7:00
   :END:
   #+BEGIN: clocktable :maxlevel 2 :scope subtree
   #+CAPTION: Clock summary at [2016-08-17 三 00:09]
   | Headline                      | Time    |       |
   |-------------------------------+---------+-------|
   | *Total time*                  | *10:56* |       |
   |-------------------------------+---------+-------|
   | \_  TODO 《GitHub入门与实践》 |         | 10:56 |
   #+END:
   :LOGBOOK:
...
**** 帮助大家深入理解Git的资料
 ...
 3. try Git
*** TODO 第5章  详细解说GitHub的功能
*** TODO 第6章  尝试Pull Request
*** TODO 第7章  接受Pull Request
*** TODO 第8章  与GitHub相互协作的工具及服务
*** TODO 第9章  使用GitHub的开发流程
*** TODO 第10章 将GitHub应用到企业
*** TODO 附录A  支持GitHub的GUI客户端
*** TODO 附录B  通过Gist轻松实现代码共享
*** TODO 复习
    :LOGBOOK:
